...
/*EzServerClient.GlobeParams.MapSrcURL = [
	["矢量地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/default"]],
	["影像地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/State"]],
	["矢量叠加地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/RV"]]
];http://map.pgis.sc:9083/PGIS_S_TileMap/js/EzMapAPI.js*/

EzServerClient.GlobeParams.MapSrcURL = [
	["矢量地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/default"]],
	["影像地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/sate"]],
	["矢量叠加地图",["http://map.pgis.sc:9083/PGIS_S_TileMapServer/Maps/sateRV"]]];
/*
EzServerClient.GlobeParams.MapSrcURL = [
	["矢量地图",["http://10.64.250.163:9083/PGIS_S_TileMapServer/Maps/default"]],
	["影像地图",["http://10.64.250.163:9083/PGIS_S_TileMapServer/Maps/sate"]],
	["矢量叠加地图",["http://10.64.250.163:9083/PGIS_S_TileMapServer/Maps/sateRV"]]];
	*/
 ...
 *参数举例：如下所示
 */
EzServerClient.GlobeParams.MapFullExtent = [103.46679,27.8291,105.625,29.27441];
 ...
 *取值范围：无
 *默认值：无
 *参数举例：如下所示 <script type="text/javascript" charset="GB2312" src="http://map.pgis.sc:9083/PGIS_S_TileMap/js/EzMapAPI.js"></script>
 */
EzServerClient.GlobeParams.EzServerClientURL = "http://map.pgis.sc:9083/PGIS_S_TileMap";
 ...
 *参数举例：如下所示
 */
EzServerClient.GlobeParams.EzMapServiceURL = "http://10.67.1.141:8889/EzMapService";	
...
/**
 *字符集配置，默认引入"字符集为UTF-8"，如果想引入"字符集为UTF-8"，将"字符集为UTF-8"打开，注销"字符集为UTF-8"部分
 */
/**********************************字符集为UTF-8***********************************/
//引入EzServerClient6.js脚本
document.writeln("<script type='text/javascript' charset='GB2312' src='" + EzServerClient.GlobeParams.EzServerClientURL + "/js/EzMapAPI.js'></script>");
// 引用EzServer.css样式表
...
//document.writeln("<script type='text/javascript' charset='UTF-8' src='" + EzServerClient.GlobeParams.EzGeoPSURL + "/ezgeops_js/EzGeoPS.js'></script>");
...
// 引用EzServer.css样式表
document.writeln("<LINK charset='UTF-8' href='" + EzServerClient.GlobeParams.EzServerClientURL + "/css/EzServer_UTF-8.css' type='text/css' rel='stylesheet'>");
// 如果配置了地理处理服务EzGeographicProcessingService，通过以下引入相关脚本
document.writeln("<script type='text/javascript' charset='UTF-8' src='" + EzServerClient.GlobeParams.EzGeoPSURL + "/ezgeops_js/EzGeoPS.js'></script>");
*/